      ...
      <div className="glass-panel w-full max-w-md p-10 rounded-3xl border-t border-l border-white/20 relative z-10">
        ...
        <form className="space-y-6">
          <div>
            ...
            <input id="email" name="email" type="email" placeholder="name@company.com" className="w-full bg-black/50 border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder:text-white/20" />
          </div>
          <div>
            ...
            <input id="password" name="password" type="password" placeholder="••••••••" className="w-full bg-black/50 border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder:text-white/20" />
          </div>
