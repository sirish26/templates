export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:py-24">
      <h1 className="text-5xl sm:text-7xl font-black uppercase tracking-tighter mb-10 sm:mb-12">Background</h1>
      <div className="prose prose-xl font-medium">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12 border-t-2 border-black pt-12">
          <div>
