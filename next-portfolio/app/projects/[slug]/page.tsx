  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 sm:px-6 sm:py-24">
      <div className="mb-12 flex flex-col gap-4">
        ...
        <h1 className="text-5xl sm:text-7xl font-black uppercase tracking-tighter">{project.title}</h1>
        <p className="text-lg sm:text-xl font-medium max-w-3xl leading-relaxed">{project.description}</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="rounded-lg border-4 border-black p-6 bg-white sm:p-10">
          <h2 className="text-2xl sm:text-3xl font-black uppercase mb-6">Project details</h2>
          <p className="mb-4 text-sm uppercase tracking-[0.2em] text-[#777]">Slug</p>
          <div className="mb-8 text-xl sm:text-2xl font-bold">{project.slug}</div>
        ...
        <div className="rounded-lg border-4 border-black p-6 bg-white sm:p-10">
          <h2 className="text-2xl sm:text-3xl font-black uppercase mb-6">What you get</h2>
